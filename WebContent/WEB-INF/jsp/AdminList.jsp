					...
					<div class="row">
							<div class="col-sm-3">
								<div class="input-group">
										<span class="btn btn-sm btn-primary" style="font-size: 18px;">系统用户信息：</span>
								</div>
							</div>
						</div>
						...
						<div class="table-responsive" id ="div" >		
								...
								<tbody>
									<c:choose>
										<c:when test="${not empty page}">
												<c:forEach items="${page.records}" var="admin" varStatus="stat">
												<tr>
													<td></td>
													<td>${stat.count}</td>
													...
													<!-- 用户的删除 -->
													<td>
													<a href="${pageContext.request.contextPath}/admin/deleteAdmin.action?aid=${admin.id}" onclick="return findDe()" >
							...
							<!-- 用户的增加 -->
							<a href="${pageContext.request.contextPath }/show/addAdmin.action">
